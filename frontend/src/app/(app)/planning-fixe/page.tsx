...
import type { Formateur, Groupe, Salle, PlanningFixe, Scenario } from '@/types/planning'

export default async function PlanningFixePage() {
  const supabase = await createClient()

  const [{ data: salles }, { data: groupes }, { data: formateurs }, { data: planning }, { data: scenarios }] =
    await Promise.all([
