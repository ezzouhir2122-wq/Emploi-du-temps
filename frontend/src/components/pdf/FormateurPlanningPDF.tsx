...
export interface PlanningRowPDF {
  jour_semaine: JourSemaine
  statut: StatutFixe
  groupe_nom?: string | null
}

export interface FormateurPlanningPDFProps {
  formateurNom: string
  matricule?: string | null
  salleNom: string
  poleNom?: string | null
  planning: PlanningRowPDF[]
  totalSeances: number
  totalHeures: number
...
export function FormateurPlanningPDF({
  formateurNom, matricule, salleNom, poleNom,
      ...
      <Page size="A4" orientation="landscape" style={s.page}>
        ...
        <View style={s.headerBand}>
          ...
          <View style={s.titleBlock}>
            <Text style={s.docTitle}>EMPLOI DU TEMPS HEBDOMADAIRE</Text>
            <Text style={s.docSubtitle}>Planning fixe — Formation Professionnelle</Text>
          </View>
        ...
        <View style={s.infoStrip}>
          <View style={s.infoCell}>
            <Text style={s.infoLabel}>Formateur / Formatrice</Text>
            <Text style={s.infoValue}>{formateurNom}</Text>
            {matricule && <Text style={s.infoValueSub}>Matricule : {matricule}</Text>}
          </View>
          <View style={s.infoCell}>
            <Text style={s.infoLabel}>Salle affectée</Text>
          ...
          <View style={s.infoCell}>
            ...
            <Text style={s.infoValue}>Planning hebdomadaire fixe</Text>
        ...
        <View style={s.tableWrap}>
          ...
          {activeSlots.length === 0 && (
            <View style={s.emptyMsg}>
              <Text style={s.emptyText}>Aucune séance planifiée</Text>
            </View>
          )}
        </View>
        ...
        <View style={s.summaryBar}>
          <View style={[s.summaryCell, { backgroundColor: BLUE_LIGHT }]}>
            <Text style={[s.summaryBigNum, { color: BLUE }]}>{totalSeances}<Text style={[s.summaryNumUnit, { color: BLUE }]}>/10</Text></Text>
        ...
        <View style={s.sigSection}>
          <View style={s.sigBox}>
            <Text style={s.sigTitle}>Le / La Formateur(trice)</Text>
        ...
        <View style={s.footer}>
          <View style={s.footerLeft}>
            ...
            <Text style={s.footerText}>OFPPT — Office de la Formation Professionnelle et de la Promotion du Travail</Text>
          </View>
